...
class TestIntel8080(TestCase):
    ...
    def test_adc_r_overflow(self):
        try:
            intel = Intel8080()
            intel.init_test("adc e")

            intel.set_acc(255)
            intel.registers.set_register8_with_offset(char_to_reg("E"), 1)
    ...
    def test_adc_r_overflow_with_carry_2(self):
        try:
            intel = Intel8080()
            intel.init_test("adc e")
    ...
    def test_adc_r_2(self):
        try:
            ...
            self.assertEqual(16, intel.get_acc())
    ...
    def test_adc_r_sign(self):
        try:
            ...
            self.assertEqual(128, intel.get_acc())
            self.assertFalse(intel.ALU.get_carry_flag())
            self.assertTrue(intel.ALU.get_auxiliary_carry_flag())
            self.assertFalse(intel.ALU.get_zero_flag())
