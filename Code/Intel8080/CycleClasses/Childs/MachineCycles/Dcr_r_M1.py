...
from Code.Intel8080.CycleClasses.Childs.States.tmp_minus_1_to_ddd import tmp_minus_1_to_ddd


class Dcr_r_M1(Fetch):
    def __init__(self, processor):
        super().__init__(processor)
        self.states.append(ddd_to_tmp(processor))
        self.states.append(tmp_minus_1_to_ddd(processor))
