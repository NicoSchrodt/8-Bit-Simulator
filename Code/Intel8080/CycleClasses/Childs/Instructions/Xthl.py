from Code.Intel8080.CycleClasses.Childs.MachineCycles.Xthl_M1 import Xthl_M1
...
class Xthl(Instruction):
    def __init__(self, processor):
        ...
        self.machine_cycles = [Xthl_M1(processor), Xthl_M2(processor), Xthl_M3(processor),
                               Xthl_M4(processor), Xthl_M5(processor)]
        pass
