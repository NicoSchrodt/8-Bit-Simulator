...
from Code.Intel8080.CycleClasses.Childs.MachineCycles.act_minus_tmp_minus_cy_to_acc_mc import \
    act_minus_tmp_minus_cy_to_acc_mc
...
class Sbi(Instruction):
    def __init__(self, processor):
        ...
        self.machine_cycles = [acc_to_act_mc(processor),
                               b2_to_tmp(processor),
                               act_minus_tmp_minus_cy_to_acc_mc(processor)]
        pass
