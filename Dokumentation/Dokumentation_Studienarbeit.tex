...
Von Andreas\\
1966 wurden von Micheal Flynn die folgenden vier Arten von Parallelisierung eingeführt \cite{Flynn}:
...
Der Intel 8080 besitzt ein SRAM Array mit 16-bit Register. Darin enthalten sind der Programm Counter mit 16-bit und der Stack Pointer mit 16-bit. Dazu gibt es noch acht weitere 8-bit Register. Diese können entweder alleine oder zusammen mit einem anderen 8-bit Register als ein 16-bit Register verwendet werden. Dabei gibt es aber nur die fest vorgegebenen Kombinationen. Das B- und C-Register, das D- und E-Register, das H- und L- Register und die temporären W- und Z- Register. Die W- und Z-Register können nicht vom Programmierer verwendet werden und dienen nur zur internen Ausführung von Befehlen. Bei manchen Befehlen kann der Stackpointer als 16-Bit Register verwendet werden.
...
\noindent
Für die binäre Subtraktion wurde der Trick angewandt, dass das Zweier-Komplement einer Positiven Zahl, den negativen Wert davon darstellt. Wenn dieser Wert dann zu dem anderen Operanden hinzu addiert wird, kommt das Ergebnis der Subtraktion heraus.
...
\bibitem{Flynn}
Some Computer Organizations and Their Effectiveness: M. J. Flynn, vol. C-21, no. 9, pp. 948-960, Sept. 1972, IEEE Transactions on Computers
\bibitem{Intel8080Manual}
Intel 8080 Microcomputer Systems User's Manual:\url{http://bitsavers.trailing-edge.com/components/intel/MCS80/98-153B_Intel_8080_Microcomputer_Systems_Users_Manual_197509.pdf}, zuletzt abgerufen: 13.05.2022
