...
\noindent
Die Aufgabengebiete bei diesem Simulator waren klar verteilt. Nico Schrodt hat sich mit dem Frontend befasst, also die graphische Oberfläche, und Andreas Schmider hat sich um das Backend gekümmert, also die Funktionsweise des Prozessors. Diese zwei Bereiche können gut voneinander getrennt werden. Somit musste sich nur auf wenige Schnittstellen geeinigt werden.
